...
module.exports = function Start(input) {
    ...
    //         }
            ...
            console.log('Altura: ' + model.terreno.altura)
            console.log('Largura: ' + model.terreno.largura)
    ...
    function sortRandomPosition (model, matriz) {
        ...
        //numbers = randomIntInc(0, 99, positions);

        let teste = [12,55,100,115,7,0,11]

        for(i = 0; i < positions; i++){
            if(teste[i] < 100){teste[i] = leftPad(teste[i], 2)}
        }

        // for(i = 0; i < positions; i++){
        //     if(numbers[i] < 100){numbers[i] = leftPad(numbers[i], 2)}
        // }
        
        //console.log('Array de Numeros random: ' + numbers);
        console.log('Array de Numeros Teste: ' + teste);
        
        
        setPosition(teste, matriz, 'A', countA)
        setPosition(teste, matriz, '*', countN)
    ...
    function sliceNumber(number){
        ...
        console.log('Array de numeros: ' + ret)
